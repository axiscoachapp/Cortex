...
import { CalendarIcon, Trash2, Mail, MessageCircle, Loader2 } from 'lucide-react';
...
export function AppointmentModal({
  ...
  const handleSave = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: isEdit ? 'Consulta atualizada!' : 'Consulta agendada!' });
      onSaved();
      onOpenChange(false);
    } catch (err: any) {
      ...
      <DialogContent className="sm:max-w-[520px] max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSave} className="space-y-4 mt-2">
          ...
          <div className="flex gap-2 pt-2">
            ...
            <Button type="submit" variant="medical" disabled={saving || !title.trim()}>
